...
#import "ivdeAutoAuthEntry.h"
#import "ivdeAutoAuthWebModule.h"
#import "WeexInitManager.h"
#import <WebKit/WKWebView.h>

WEEX_PLUGIN_INIT(ivdeAutoAuthEntry)
@implementation ivdeAutoAuthEntry
...
{
    [callCommon setJSCallAssign:webView name:@"ivdeAutoAuth" bridge:[[ivdeAutoAuthWebModule alloc] init]];
}
